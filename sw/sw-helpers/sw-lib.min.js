...
*/
(function(t,r){'object'==typeof exports&&'undefined'!=typeof module?module.exports=r():'function'==typeof define&&define.amd?define(r):(t.goog=t.goog||{},t.goog.swlib=r())})(this,function(){'use strict';function createCommonjsModule(te,ae){return ae={exports:{}},te(ae,ae.exports),ae.exports}function throwError(te){const ae=new Error(te),ne=d.parse(ae);throw 3<=ne.length&&(ae.message=`Invalid call to ${ne[2].functionName}() — `+te.replace(/\s+/g,' '),ae.name=ne[1].functionName.replace(/^Object\./,'')),ae}function parse(te,ae){for(var le,ne=[],se=0,ie=0,ce='',oe=ae&&ae.delimiter||'/';null!=(le=x.exec(te));){var de=le[0],pe=le[1],ue=le.index;if(ce+=te.slice(ie,ue),ie=ue+de.length,pe){ce+=pe[1];continue}var he=te[ie],me=le[2],ge=le[3],fe=le[4],ye=le[5],be=le[6],_e=le[7];ce&&(ne.push(ce),ce='');var Ce=le[2]||oe,xe=fe||ye;ne.push({name:ge||se++,prefix:me||'',delimiter:Ce,optional:'?'===be||'*'===be,repeat:'+'===be||'*'===be,partial:null!=me&&null!=he&&he!==me,asterisk:!!_e,pattern:xe?escapeGroup(xe):_e?'.*':'[^'+escapeString(Ce)+']+?'})}return ie<te.length&&(ce+=te.substr(ie)),ce&&ne.push(ce),ne}function encodeURIComponentPretty(te){return encodeURI(te).replace(/[\/?#]/g,function(ae){return'%'+ae.charCodeAt(0).toString(16).toUpperCase()})}function encodeAsterisk(te){return encodeURI(te).replace(/[?#]/g,function(ae){return'%'+ae.charCodeAt(0).toString(16).toUpperCase()})}function tokensToFunction(te){for(var ae=Array(te.length),ne=0;ne<te.length;ne++)'object'==typeof te[ne]&&(ae[ne]=new RegExp('^(?:'+te[ne].pattern+')$'));return function(se,ie){for(var ue,ce='',oe=se||{},le=ie||{},de=le.pretty?encodeURIComponentPretty:encodeURIComponent,pe=0;pe<te.length;pe++){if(ue=te[pe],'string'==typeof ue){ce+=ue;continue}var me,he=oe[ue.name];if(null==he)if(ue.optional){ue.partial&&(ce+=ue.prefix);continue}else throw new TypeError('Expected "'+ue.name+'" to be defined');if(y(he)){if(!ue.repeat)throw new TypeError('Expected "'+ue.name+'" to not repeat, but received `'+JSON.stringify(he)+'`');if(0===he.length)if(ue.optional)continue;else throw new TypeError('Expected "'+ue.name+'" to not be empty');for(var ge=0;ge<he.length;ge++){if(me=de(he[ge]),!ae[pe].test(me))throw new TypeError('Expected all "'+ue.name+'" to match "'+ue.pattern+'", but received `'+JSON.stringify(me)+'`');ce+=(0===ge?ue.prefix:ue.delimiter)+me}continue}if(me=ue.asterisk?encodeAsterisk(he):de(he),!ae[pe].test(me))throw new TypeError('Expected "'+ue.name+'" to match "'+ue.pattern+'", but received "'+me+'"');ce+=ue.prefix+me}return ce}}function escapeString(te){return te.replace(/([.+*?=^!:${}()[\]|\/\\])/g,'\\$1')}function escapeGroup(te){return te.replace(/([=!:$\/()])/g,'\\$1')}function attachKeys(te,ae){return te.keys=ae,te}function flags(te){return te.sensitive?'':'i'}function regexpToRegexp(te,ae){var ne=te.source.match(/\((?!\?)/g);if(ne)for(var se=0;se<ne.length;se++)ae.push({name:se,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,asterisk:!1,pattern:null});return attachKeys(te,ae)}function arrayToRegexp(te,ae,ne){for(var se=[],ie=0;ie<te.length;ie++)se.push(pathToRegexp(te[ie],ae,ne).source);var ce=new RegExp('(?:'+se.join('|')+')',flags(ne));return attachKeys(ce,ae)}function stringToRegexp(te,ae,ne){return tokensToRegExp(parse(te,ne),ae,ne)}function tokensToRegExp(te,ae,ne){y(ae)||(ne=ae||ne,ae=[]),ne=ne||{};for(var le,se=ne.strict,ie=!1!==ne.end,ce='',oe=0;oe<te.length;oe++)if(le=te[oe],'string'==typeof le)ce+=escapeString(le);else{var de=escapeString(le.prefix),pe='(?:'+le.pattern+')';ae.push(le),le.repeat&&(pe+='(?:'+de+pe+')*'),pe=le.optional?le.partial?de+'('+pe+')?':'(?:'+de+'('+pe+'))?':de+'('+pe+')',ce+=pe}var ue=escapeString(ne.delimiter||'/'),he=ce.slice(-ue.length)===ue;return se||(ce=(he?ce.slice(0,-ue.length):ce)+'(?:'+ue+'(?=$))?'),ce+=ie?'$':se&&he?'':'(?='+ue+'|$)',attachKeys(new RegExp('^'+ce,flags(ne)),ae)}function pathToRegexp(te,ae,ne){return y(ae)||(ne=ae||ne,ae=[]),ne=ne||{},te instanceof RegExp?regexpToRegexp(te,ae):y(te)?arrayToRegexp(te,ae,ne):stringToRegexp(te,ae,ne)}function broadcastUpdate({channel:te,cacheName:ae,url:ne,source:se}){u.isInstance({channel:te},BroadcastChannel),u.isType({cacheName:ae},'string'),u.isType({source:se},'string'),u.isType({url:ne},'string'),te.postMessage({type:Z,meta:se,payload:{cacheName:ae,updatedUrl:ne}})}function responsesAreSame({first:te,second:ae,headersToCheck:ne}={}){if(!(te instanceof Response&&ae instanceof Response&&ne instanceof Array))throw z.createError('responses-are-same-parameters-required');return ne.every((se)=>{return te.headers.has(se)===ae.headers.has(se)&&te.headers.get(se)===ae.headers.get(se)})}class ErrorFactory$1{constructor(te){this._errors=te}createError(te,ae){if(!(te in this._errors))throw new Error(`Unable to generate error '${te}'.`);let ne=this._errors[te].replace(/\s+/g,' '),se=null;ae&&(ne+=` [${ae.message}]`,se=ae.stack);const ie=new Error;return ie.name=te,ie.message=ne,ie.stack=se,ie}}const t={'not-in-sw':'sw-lib must be loaded in your service worker file.','unsupported-route-type':'Routes must be either a express style route string, a Regex to capture request URLs or a Route instance.','empty-express-string':'The Express style route string must have some characters, an empty string is invalid.','bad-revisioned-cache-list':`The 'cacheRevisionedAssets()' method expects`+`an array of revisioned urls like so: ['/example/hello.1234.txt', `+`{path: 'hello.txt', revision: '1234'}]`};var r=new ErrorFactory$1(t);const a={'express-route-requires-absolute-path':`When using ExpressRoute, you must
    provide a path that starts with a '/' character. You can only match
    same-origin requests. For more flexibility, use RegExpRoute.`};var s=new ErrorFactory$1(a),o='undefined'==typeof window?'undefined'==typeof global?'undefined'==typeof self?{}:self:global:window,l=createCommonjsModule(function(te){(function(ne,se){'use strict';te.exports=se()})(o,function(){'use strict';function _isNumber(pe){return!isNaN(parseFloat(pe))&&isFinite(pe)}function _capitalize(pe){return pe[0].toUpperCase()+pe.substring(1)}function _getter(pe){return function(){return this[pe]}}function StackFrame(pe){if(pe instanceof Object)for(var ue=ne.concat(se.concat(ie.concat(ce))),he=0;he<ue.length;he++)pe.hasOwnProperty(ue[he])&&void 0!==pe[ue[he]]&&this['set'+_capitalize(ue[he])](pe[ue[he]])}var ne=['isConstructor','isEval','isNative','isToplevel'],se=['columnNumber','lineNumber'],ie=['fileName','functionName','source'],ce=['args'];StackFrame.prototype={getArgs:function(){return this.args},setArgs:function(pe){if('[object Array]'!==Object.prototype.toString.call(pe))throw new TypeError('Args must be an Array');this.args=pe},getEvalOrigin:function(){return this.evalOrigin},setEvalOrigin:function(pe){if(pe instanceof StackFrame)this.evalOrigin=pe;else if(pe instanceof Object)this.evalOrigin=new StackFrame(pe);else throw new TypeError('Eval Origin must be an Object or StackFrame')},toString:function(){var pe=this.getFunctionName()||'{anonymous}',ue='('+(this.getArgs()||[]).join(',')+')',he=this.getFileName()?'@'+this.getFileName():'',me=_isNumber(this.getLineNumber())?':'+this.getLineNumber():'',ge=_isNumber(this.getColumnNumber())?':'+this.getColumnNumber():'';return pe+ue+he+me+ge}};for(var oe=0;oe<ne.length;oe++)StackFrame.prototype['get'+_capitalize(ne[oe])]=_getter(ne[oe]),StackFrame.prototype['set'+_capitalize(ne[oe])]=function(pe){return function(ue){this[pe]=!!ue}}(ne[oe]);for(var le=0;le<se.length;le++)StackFrame.prototype['get'+_capitalize(se[le])]=_getter(se[le]),StackFrame.prototype['set'+_capitalize(se[le])]=function(pe){return function(ue){if(!_isNumber(ue))throw new TypeError(pe+' must be a Number');this[pe]=+ue}}(se[le]);for(var de=0;de<ie.length;de++)StackFrame.prototype['get'+_capitalize(ie[de])]=_getter(ie[de]),StackFrame.prototype['set'+_capitalize(ie[de])]=function(pe){return function(ue){this[pe]=ue+''}}(ie[de]);return StackFrame})}),d=createCommonjsModule(function(te){(function(ne,se){'use strict';te.exports=se(l)})(o,function ErrorStackParser(ne){'use strict';var se=/(^|@)\S+\:\d+/,ie=/^\s*at .*(\S+\:\d+|\(native\))/m,ce=/^(eval@)?(\[native code\])?$/;return{parse:function ErrorStackParser$$parse(oe){if('undefined'!=typeof oe.stacktrace||'undefined'!=typeof oe['opera#sourceloc'])return this.parseOpera(oe);if(oe.stack&&oe.stack.match(ie))return this.parseV8OrIE(oe);if(oe.stack)return this.parseFFOrSafari(oe);throw new Error('Cannot parse given Error object')},extractLocation:function ErrorStackParser$$extractLocation(oe){if(-1===oe.indexOf(':'))return[oe];var le=/(.+?)(?:\:(\d+))?(?:\:(\d+))?$/,de=le.exec(oe.replace(/[\(\)]/g,''));return[de[1],de[2]||void 0,de[3]||void 0]},parseV8OrIE:function ErrorStackParser$$parseV8OrIE(oe){var le=oe.stack.split('\n').filter(function(de){return!!de.match(ie)},this);return le.map(function(de){-1<de.indexOf('(eval ')&&(de=de.replace(/eval code/g,'eval').replace(/(\(eval at [^\()]*)|(\)\,.*$)/g,''));var pe=de.replace(/^\s+/,'').replace(/\(eval code/g,'(').split(/\s+/).slice(1),ue=this.extractLocation(pe.pop()),he=pe.join(' ')||void 0,me=-1<['eval','<anonymous>'].indexOf(ue[0])?void 0:ue[0];return new ne({functionName:he,fileName:me,lineNumber:ue[1],columnNumber:ue[2],source:de})},this)},parseFFOrSafari:function ErrorStackParser$$parseFFOrSafari(oe){var le=oe.stack.split('\n').filter(function(de){return!de.match(ce)},this);return le.map(function(de){if(-1<de.indexOf(' > eval')&&(de=de.replace(/ line (\d+)(?: > eval line \d+)* > eval\:\d+\:\d+/g,':$1')),-1===de.indexOf('@')&&-1===de.indexOf(':'))return new ne({functionName:de});var pe=de.split('@'),ue=this.extractLocation(pe.pop()),he=pe.join('@')||void 0;return new ne({functionName:he,fileName:ue[0],lineNumber:ue[1],columnNumber:ue[2],source:de})},this)},parseOpera:function ErrorStackParser$$parseOpera(oe){return!oe.stacktrace||-1<oe.message.indexOf('\n')&&oe.message.split('\n').length>oe.stacktrace.split('\n').length?this.parseOpera9(oe):oe.stack?this.parseOpera11(oe):this.parseOpera10(oe)},parseOpera9:function ErrorStackParser$$parseOpera9(oe){for(var me,le=/Line (\d+).*script (?:in )?(\S+)/i,de=oe.message.split('\n'),pe=[],ue=2,he=de.length;ue<he;ue+=2)me=le.exec(de[ue]),me&&pe.push(new ne({fileName:me[2],lineNumber:me[1],source:de[ue]}));return pe},parseOpera10:function ErrorStackParser$$parseOpera10(oe){for(var me,le=/Line (\d+).*script (?:in )?(\S+)(?:: In function (\S+))?$/i,de=oe.stacktrace.split('\n'),pe=[],ue=0,he=de.length;ue<he;ue+=2)me=le.exec(de[ue]),me&&pe.push(new ne({functionName:me[3]||void 0,fileName:me[2],lineNumber:me[1],source:de[ue]}));return pe},parseOpera11:function ErrorStackParser$$parseOpera11(oe){var le=oe.stack.split('\n').filter(function(de){return!!de.match(se)&&!de.match(/^Error created at/)},this);return le.map(function(de){var pe=de.split('@'),ue=this.extractLocation(pe.pop()),he=pe.shift()||'',me=he.replace(/<anonymous function(: (\w+))?>/,'$2').replace(/\([^\)]*\)/g,'')||void 0,ge;he.match(/\(([^\)]*)\)/)&&(ge=he.replace(/^[^\(]+\(([^\)]*)\)$/,'$1'));var fe=ge===void 0||'[arguments not available]'===ge?void 0:ge.split(',');return new ne({functionName:me,args:fe,fileName:ue[0],lineNumber:ue[1],columnNumber:ue[2],source:de})},this)}}})}),u={atLeastOne:function atLeastOne(te){const ae=Object.keys(te);ae.some((ne)=>te[ne]!==void 0)||throwError('Please set at least one of the following parameters: '+ae.map((ne)=>`'${ne}'`).join(', '))},hasMethod:function hasMethod(te,ae){const ne=Object.keys(te).pop(),se=typeof te[ne][ae];'function'!=se&&throwError(`The '${ne}' parameter must be an object that exposes a
