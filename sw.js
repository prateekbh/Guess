...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(4)(module), __webpack_require__(2)))
...
goog.swlib.cacheRevisionedAssets(['/images/logo.svg', '/images/logo.png', '/images/surprised.svg', 'https://fonts.googleapis.com/icon?family=Material+Icons', 'https://fonts.googleapis.com/css?family=Roboto:300,400,500']);

goog.swlib.warmRuntimeCache(['/', '/play']);
...
goog.swlib.router.registerRoute(/https:\/\/images.pexels.com\//, goog.swlib.cacheFirst({
  cacheName: 'word-images'
}));

var bgQueue = new goog.backgroundSyncQueue.BackgroundSyncQueue();

var bgQRoute = new goog.swlib.Route({
...
messaging.setBackgroundMessageHandler(function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee(payload) {
    var gameData, notificationTitle, notificationOptions;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return idbKeyval.get('game-data');
          ...
          case 3:
            ...
            _context.next = 7;
            return idbKeyval.set('game-data', gameData);

          case 7:
            // Customize notification here
            notificationTitle = 'Guess!';
            notificationOptions = {
              body: 'Yay! Your free hint has arrived',
              icon: '/images/icons/icon-512x512.png'
            };
            return _context.abrupt('return', self.registration.showNotification(notificationTitle, notificationOptions));
...
self.addEventListener('notificationclick', function (event) {
  ...
  event.waitUntil(clients.matchAll().then(function (matchedClients) {
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;

    try {
      for (var _iterator = matchedClients[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
